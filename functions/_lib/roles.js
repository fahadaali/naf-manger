...
// (`getDefaultPermissions`). ومصدران لقرارٍ واحد انحرافٌ مؤجَّل: تُوحَّد
// في دفعة طبقة البيانات حين تنتقل إدارة الأعضاء إلى هذه المسارات، ولا
// تُوحَّد قبلها لأن الواجهة اليوم تكتب في Supabase لا في D1.
