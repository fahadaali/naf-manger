 ...
 *
 * وكان مكانَه `supabaseDatabase.ts` ينادي Supabase من المتصفّح مباشرةً
 * بمفتاحٍ عامّ، والحراسةُ سياساتُ صفوفٍ في القاعدة. صار النداء يمرّ
 * بالـWorker، والحراسةُ دورُ العضو يُقرأ هناك — فلا مفتاح قاعدةٍ في
 * المتصفّح أصلاً، ولا جدولَ يُبلَغ بغير مسارٍ محروس.
 */
