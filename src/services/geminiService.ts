 ...
 * ٤) هذا الملفّ يبقى واجهةً: `sendMessage` تنادي المسار.
 *
 * ═══ ولا شاشةَ تناديه اليوم ═══
 *
 * كانت شاشتان تستعملانه، وسقطتا كلتاهما: «المساعد الذكي» حُذف مع الكود
 * الميت — مكوّنٌ لا يقود إليه مسار — و«المحامي الذكي» حُذف بطلبٍ صريح،
 * وخدمتُه في منصةٍ أخرى. (وهو لم يكن يستعمل هذا الملفّ أصلاً: كان
 * مُشغِّلاً يفتح GPT خارجياً.)
 *
 * فالملفّ اليوم بلا مستعمِل، ويبقى وثيقةَ قرارٍ لا شيفرةً عاملة: من أراد
 * ربطَ مساعدٍ يجد فيه ما يلزم — والسطحُ `sendMessage` و`testConnection` و
 * `isReady` و`reinitialize` محفوظٌ لذلك اليوم.
 */
